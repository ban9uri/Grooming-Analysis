...
st.markdown(
"""
디시인사이드와 트위터 모두 공통적으로 ‘좋다’, ‘좋아하다’, ‘잘생기다’, ‘많다’, ‘중요하다’, ‘필요하다’, ‘예쁘다’ 등의 긍정적 성격의
형용사는 ‘싫다’, ‘싫어하다’ 등의 부정적 성격의 형용사와 공존하였다. 추출 결과 긍정적 형용사가 부정적 형용사에 비해 종류가 더 많고 빈도가 더 높음을 확인할 수 있었다.
"""
)
st.markdown(
"""
