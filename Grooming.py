...
"""
##### ▶ 용어의 용례
흥미로운 것은, 외모관리에 대한 남성들의 관심은 지속적으로 긍정적인 방향으로 증가하였고
언론에서는 그루밍족이라는 용어의 긍정적 용례가 확인되는 것이 대부분이나, 남성 인터넷
커뮤니티상에서 그루밍족이라는 용어는 그 내용을 감성분석한 결과, 대체로 부정적인 용례로
사용됨을 확인할 수 있었다.
...
손톱/발톱 관리, 7.6%를 차지한 성형수술/시술이 그 뒤를 이었다. 
###### *남성 외모 관리 방법*
"""
)
...
헤어 분야에서는 기우쌤, 헬스 분야에서는 말왕TV, 화장 분야에서는 레오제이를 선정하였다. 아래의 그래프를 보면
