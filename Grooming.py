...
"""
##### ▶ 용어의 용례
흥미로운 것은, 남성 인터넷 커뮤니티상에서 그루밍족이라는 용어가 사용된 용례는, 그 내용을 감성분석한 결과, 대체로 부정적임이
확인되었다는 것이다. 이는 외모관리에 대한 남성들의 관심이 지속적으로 긍정적인 방향으로 증가하였고 언론에서 사용한 그루밍족이라는
용어의 용례가 대체로 긍정적인 것으로 확인되는 것과는 대비된다.
...
st.markdown(
"""
구체적인 외모 관리의 방법은 아래 그래프와 같다. 오픈서베이의 <2022 남성 그루밍 트렌드 리포트>에 따르면, 기초화장품을 통해 피부 관리를 한다고 응답한
...
"""
##### ▶ 남성 그루밍 시장 성장세
국내 남성 화장품 시장은 매년 10% 이상의 성장률을 기록하며 꾸준히 성장 중이다. 2020년 기준 이미 1조 4천억 원 이상의
